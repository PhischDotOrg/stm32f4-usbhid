...
extern const ::usb::UsbStringDescriptors_t usbStringDescriptors __attribute__((aligned(4), section(".fixeddata"))) = {
        .m_stringDescriptorTable = {
                ...
                .m_product          = ::usb::UsbStringDescriptor("PhiSch.org USB HID Demo on STM32F4Discovery"),
                .m_serialNumber     = ::usb::UsbStringDescriptor("760D4F1C-72FE-4DC9-84A3-80F50BBF55B2"),
